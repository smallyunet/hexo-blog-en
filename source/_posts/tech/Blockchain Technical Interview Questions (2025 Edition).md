...
There’s currently an issue in the blockchain industry: there is no systematic theoretical framework, only fragmented, cutting-edge engineering experiments. Compare this with programming languages: from Church’s and Turing’s models of computation to functional programming languages, compilers, and type systems, decades of development in academia and industry have produced both highly abstract theoretical foundations and practical industrial applications. The field is relatively mature. Blockchain, however, is still new. It emerged in 2008 and began entering public awareness around 2013. That has not been enough time to establish a solid academic system. Instead, projects go their own ways, creating separate standards and defining their own terminology. Account models, consensus, contracts, and cross-chain systems all differ from one blockchain to another. Could anyone unify blockchain into a coherent theoretical framework? Even Vitalik could not do it; perhaps there would be hope if Satoshi returned.

That is why there is no need to put much faith in university “blockchain majors.” How could teachers and professors who have never left academia already have had enough time to abstract blockchain technology into theory, write textbooks, develop curricula, and teach it to students? Consider how long that cycle would take. For the same reason, do not place too much trust in published technical books. Publishing a book takes years, and by the time it appears, the world has already changed. A Bitcoin conference is scheduled for the second half of this year, where the team that invented the concept of inscriptions two years ago may announce something new. How could a university course or book keep up with that pace? The most advanced technology in the industry can only come from the concrete exploration and experimentation of individual projects, which naturally results in a field that lacks a unified system.
